...
/////////////////
const BotName = 'F3BR14N0-B0T'; 
const instagram = ' https://www.instagram.com/febrianopalandima/'; 
const telegram = 'https://web.telegram.org/#/im'; 
const kapanbotaktif = 'TIDAK MENENTU'; 
const youtube = '-';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@febrianopalandima')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@febrianopalandima`)
})
