exports.menu = (id, BotName, corohelp, tampilTanggal, tampilWaktu, instagram, telegram, youtube, kapanbotaktif, grupch1, grupch2) => {
	return `⚔️*_${BotName}_*⚔️
  
          HALO!
HELLO GUYS _${BotName}_ Disini.
Sebelum menggunakan bot ini ada baiknya kalian melihat menu *!info* dan *!donasi* 😀

💵Tolong bantu donasi yaa, Agar ni bot selalu aktif💵
💵Ketik aja !donasi untuk berdonasi, Seikhlasnya yaa💵

📅*${tampilTanggal}* 🇲🇨
⏰*${tampilWaktu}* 🇲🇨
(Waktu Server)

Dibaca baik-baik ya sebelum menggunakan Command🤗

🗒KUMPULAN COMMAND _${BotName}_:
...
Contoh: !say Febriano Ganteng awokawok
...
Contoh : !pasangan Febriano & Najwa


⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇⬇
FOLLOW INSTAGRAM SAYA YA😆
${instagram}

• TELEGRAM : ${telegram}
• Youtube : -
• WA : 082211991425
• Mau Pasang Iklan? Chat aja

📺 *IKLAN* : *⚔️*
🏚JAGA KESEHATAN KAMU YAA😗!🏚
🏚TUHAN MEMBERKATI!🏚
`
}
